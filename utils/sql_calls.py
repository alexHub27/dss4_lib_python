...
(select club_id,compet_id,match_day,home_flag,club_attack_skills,adv_defence_skills
      ,case when club_goal_scored = 0 then 0
            when club_goal_scored = 1 then 1
            when (club_goal_scored = 2 or club_goal_scored = 3) then 2
            else 3
        end as target
from
...
def footbet_lstm_defence_form_test(club_id,match_dt,w,dataNm):
